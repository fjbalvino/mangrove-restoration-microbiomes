#!/usr/bin/env python3
# ============================================================
# 08_01_reproduce_figure4.py
# Status: REVIEW CANDIDATE; see docs/REPRODUCIBILITY.md
# Frozen-table figure renderer; requires the Figure4 bundle input layout. Full model fitting is separate.
# Inputs (source expressions; complete list in docs/contracts/08_01_reproduce_figure4.json):
...
# Render Figure 4 from immutable saved statistical tables; verify numerical inputs.
#   Statistical methods remain attributed to the producer analyses; plotting does not re-estimate effects.
# Source SHA-256: 3a98ffaa6f33c70859c90360d25efb976dcac442b5fbc14ccab344540818bb61
